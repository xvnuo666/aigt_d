...
from utils.metric_based import get_ll, get_rank, get_entropy, get_rank_GLTR, run_threshold_experiment, \
    run_GLTR_experiment
...
def main():
    supervised_model_list = ['bert-base', 'roberta-base', 'deberta-base', 'ChatGPT-Detector', 'flooding', 'rdrop',
                             'ranmask', 'scrn']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_files", type=str, default="./data_in/mixed-source")
    parser.add_argument("--output_dir", type=str, default="./data_out/scrn")

    args = parser.parse_args()

    # 使用解析的参数替换 `train.sh` 的功能
    import sys

    sys.argv = [
        "main.py",
        "--do_train", str(args.do_train),
        "--do_predict", str(args.do_predict),
        ...
        "--metric_base_model_name_or_path", args.metric_base_model_name_or_path,
